...
userLanguage = language.replace(/-/gi, '_')
...
function refreshSlider(){
    ...
    sliderTexts.forEach(function(sliderText, _){
        if(sliderText.dataset.translate){
            sliderText.innerHTML = languages[language][sliderText.dataset.translate]
        }
